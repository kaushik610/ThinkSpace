		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#thinkspacezadthinkspace-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"thinkspacezadthinkspace-display": {
								"semanticObject": "thinkspacezadthinkspace",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=thinkspace.zad.thinkspace",
									"url": sap.ui.require.toUrl("thinkspace/zad/thinkspace")
								}
							}
						}
					}
